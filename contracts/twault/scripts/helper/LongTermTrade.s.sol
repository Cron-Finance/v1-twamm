...
// forge script contracts/twault/scripts/helper/LongTermTrade.s.sol:LongTermTradeTestnetScript --rpc-url $GOERLI_RPC_URL --broadcast --slow -vvvv

// trade from token0 -> token1
contract LongTermTradeTestnetScript is Script {
