...
// Assuming the openzeppelin one (not the rari one) <-- TODO?
// import { ERC20 } from "typechain/ERC20";
import { ERC20 } from "typechain/contracts/twault/balancer-core-v2/lib/openzeppelin/ERC20"
import { IVault, Vault } from "typechain/contracts/twault/balancer-core-v2/vault/Vault";
...
async function getBatchSwapArgs(
  ...
  const swaps: IVault.BatchSwapStepStruct[] = [
    {
      poolId,
